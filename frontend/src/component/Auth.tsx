...
function Auth() {
  ...
  return (
    <div className='mx-auto max-w-md rounded-xl border border-slate-700 bg-slate-800 p-6 text-slate-100 shadow-2xl sm:p-8'>
      ...
      <div className='mb-6 flex justify-center rounded-lg bg-slate-700 p-1'>
        <button
          className={`w-full rounded-md px-6 py-2 text-sm font-semibold transition-colors ${isLogin ? 'bg-teal-500 text-white' : 'text-slate-400 hover:bg-slate-700'}`}
          onClick={() => {
            setIsLogin(true);
            setError('');
          }}
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  type='text'
                  className='w-full rounded-lg border border-slate-700 bg-slate-700 p-3 pl-10 text-slate-100 focus:ring-1 focus:ring-teal-500 focus:outline-none'
              ...
              <div>
                ...
                <div className='relative'>
                  ...
                  <input
                    id='signup-email'
                    type='email'
                    className='w-full rounded-lg border border-slate-700 bg-slate-700 p-3 pl-10 text-slate-100 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none'
                    name='email'
            ...
            <motion.button
              ...
              className={`w-full rounded-full px-6 py-3 text-base font-semibold text-white transition-all duration-200 ${
                isLoading
                  ...
                  : 'bg-teal-500 shadow-lg hover:bg-teal-600'
              }`}
            >
              {isLoading ? (
